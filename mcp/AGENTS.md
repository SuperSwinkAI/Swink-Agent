...
- The MCP test harness should prune the mock server's `ToolRouter` down to the configured route set. Placeholder single-tool mocks are not enough to validate US3/US4 acceptance scenarios around approval ordering and tool-filter cardinality.
