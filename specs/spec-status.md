...
<!-- spec-status: project=Swink-Agent commit=42ecd0bcf42c72513fed5a61552fc1a89e5e82ab updated=2026-07-07T03:01:55Z -->
...
| 016-adapter-azure               | ✓     | ✓  | ✓   | ✓ Complete |
| 017-adapter-xai                 | ✓     | ✓  | ✓   | ✓ Complete |
| 018-adapter-mistral             | ✓     | ✓  | ✓   | ✓ Complete |
| 019-adapter-bedrock             | ✓     | ✓  | ✓   | ✓ Complete |
...
| 036-artifact-service            | ✓     | ✓  | ✓   | ✓ Complete |
| 037-plugin-system               | ✓     | ✓  | ✓   | ✓ Complete |
...
| 043-evals-adv-features          | ✓     | ✓  | ✓   | ✓ Complete |
| 044-self-improvement-loop       | ✓     | ✓  | ✓   | ✓ Complete |
| 045-agent-rpc-service           | ✓     | ✓  | ✓   | ✓ Complete |
...
<!-- feature: 012-adapter-anthropic has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=77 tasks_completed=77 checklist_files=requirements.md -->
...
<!-- feature: 016-adapter-azure has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=54 tasks_completed=54 checklist_files=requirements.md -->
...
<!-- feature: 019-adapter-bedrock has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=41 tasks_completed=41 checklist_files=requirements.md -->
...
<!-- feature: 021-memory-crate has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=106 tasks_completed=106 checklist_files=requirements.md -->
...
<!-- feature: 023-eval-trajectory-matching has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=108 tasks_completed=108 checklist_files=requirements.md -->
...
<!-- feature: 025-tui-scaffold-config has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=63 tasks_completed=63 checklist_files=requirements.md -->
...
<!-- feature: 031-policy-slots has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=103 tasks_completed=103 checklist_files=requirements.md -->
...
<!-- feature: 036-artifact-service has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=81 tasks_completed=81 checklist_files=requirements.md -->
...
<!-- feature: 038-mcp-integration has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=49 tasks_completed=49 checklist_files=requirements.md -->
...
<!-- feature: 043-evals-adv-features has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=181 tasks_completed=181 checklist_files=requirements.md -->
<!-- feature: 044-self-improvement-loop has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=77 tasks_completed=77 checklist_files=requirements.md -->
<!-- feature: 045-agent-rpc-service has_spec=true has_plan=true has_tasks=true has_research=true has_data_model=true has_quickstart=true has_contracts=true has_checklists=true tasks_total=35 tasks_completed=35 checklist_files=requirements.md -->
