...
- [x] T045 [US4] Write alternative backends documentation section in `specs/041-gemma4-local-default/quickstart.md` — expand existing llama.cpp, vLLM, LM Studio sections with full step-by-step instructions including model download, server start, and adapter configuration
