# AGENTS.md — Agentic Loop

## Scope

`src/loop_/` — the turn engine: outer multi-turn loop, inner single-turn loop, tool dispatch, steering, cancellation, and overflow recovery.
