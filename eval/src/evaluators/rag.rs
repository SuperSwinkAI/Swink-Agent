...
/// Build the [`PromptContext`] shared by every RAG-family evaluator.
///
/// Retrieved context lives on `EvalCase::few_shot_examples`, mirroring the
/// convention established by the quality family's `FaithfulnessEvaluator`.
