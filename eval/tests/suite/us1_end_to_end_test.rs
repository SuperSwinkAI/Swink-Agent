...
fn assert_baseline_results(registry: &EvaluatorRegistry) {
    ...
    let baseline_invocation = crate::common::mock_invocation_with_response(&[], "expected answer");
...
fn assert_rag_results(registry: &EvaluatorRegistry) {
    ...
    let rag_invocation =
        crate::common::mock_invocation_with_response(&[], "Paris is the capital of France.");
...
fn assert_agent_results(registry: &EvaluatorRegistry) {
    ...
    let agent_invocation =
        crate::common::mock_invocation_with_response(&[], "The task is complete.");
...
fn assert_structured_results(registry: &EvaluatorRegistry) {
    ...
    let structured_invocation =
        crate::common::mock_invocation_with_response(&[], r#"{"answer":"expected answer"}"#);
...
fn assert_multimodal_results(registry: &EvaluatorRegistry) {
    ...
    let multimodal_invocation = crate::common::mock_invocation_with_response(&[], "safe");
...
fn us1_registry_skips_non_applicable_evaluators() {
    ...
    let invocation = crate::common::mock_invocation_with_response(&[], "42");
